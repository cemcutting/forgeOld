     ...
     `(html
       (head
        ...
        (div ((id "evaluator") (class "repl"))
             (p "Evaluator")
             ;(input ((type "text") (name "expr") (onkeydown ,(format "SendQuery('~a', this);" (embed/url eval-handler)))))
             (input ((type "text") (name "expr") (onkeydown ,(format StartXMLHttpRequest (embed/url eval-handler)))))
             (div ((id "eval-output"))))
